...
public class TelaEscolherSelecaoListarJogador {
    ...
    public TelaEscolherSelecaoListarJogador(SelecaoDaoImpl selecaoDao)
    {
    ...
    @FXML
    void btnListarJogadorAction(ActionEvent event) throws IOException {
    	String selecao = choiceBoxSelecoes.getValue();
    	TelaListarJogadores controller = new TelaListarJogadores(selecaoDao, selecao);
    	Main.trocaDeTela("/application/view/Jogador/TelaListarJogadores.fxml", controller, selecaoDao);
    }
    ...
    void initialize() {
    	...
    	assert btnListarJogador != null : "fx:id=\"btnCadastrarJogador\" was not injected: check your FXML file 'TelaEscolherSelecaoCadastrarJogador.fxml'.";
